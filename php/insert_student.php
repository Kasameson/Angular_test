...
if(isset($id_reg_student)) {
    ...
    try {
        $statement = $db_conn->prepare("INSERT INTO reg_student (
                id_reg_student,
                title_reg_student,
                fname_reg_student,
                lname_reg_student,
                gender_reg_student,
                ssn_reg_student,
                birthday_reg_student,
                address_reg_student,
                province_reg_student,
                district_reg_student,
                subdistrict_reg_student,
                postcode_reg_student,
                tell_reg_student,
                email_reg_student,
                semester_reg_student,
                class_reg_student,
                room_reg_student,
                oldschool_reg_student,
                address1_reg_student,
                father_reg_student,
                prof_reg_student,
                father_tell_reg_student,
                mother_reg_student,
                prom_reg_student,
                mother_tell_reg_student,
                password_reg_student
                )
                VALUES(
                  '$id_reg_student',
                  '$title_reg_student',
